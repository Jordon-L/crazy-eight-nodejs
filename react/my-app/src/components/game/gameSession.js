            ...
            <div class="row">
              <div class="column column-left">
                {left ? (
                  <OtherPlayers
                    location="left"
                    number={gameData.otherHands[left]}
                    name={left}
                    turn={gameData.whosTurn === left}
                  ></OtherPlayers>
                ) : (
                  <></>
                )}
              ...
              <div class="column">
                {top ? (
                  <OtherPlayers
                    location="top"
                    number={gameData.otherHands[top]}
                    name={top}
                    turn={gameData.whosTurn === top}
                  ></OtherPlayers>
                ) : (
                  <></>
                )}
              ...
              <div class="column column-right">
                {right ? (
                  <OtherPlayers
                    location="right"
                    number={gameData.otherHands[right]}
                    name={right}
                    turn={gameData.whosTurn === right}
                  ></OtherPlayers>
                ) : (
                  <></>
                )}
    ...
    return (
      <div id="game">
        ...
        <div class="row">
          <div class="column">
            <PlayerHand
              number={gameData.playerHand.length}
              cards={gameData.playerHand}
              name={gameData.playerName}
              turn={gameData.whosTurn === gameData.playerName}
            ></PlayerHand>
          </div>
        </div>
      </div>
